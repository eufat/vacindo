...
function VacindoStepButtons(props) {
  return (
...
VacindoStepButtons.defaultProps = {
  first: false,
  last: false,
  beforeLink: './',
  nextLink: './',
...
export default withRouter(withStyles(styleSheet)(VacindoStepButtons));
